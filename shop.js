(function(){
  ...
  const products = [
    ...
    create('coffee-iced', 'Cappuccino', v2(115,135), 'assets/images/capuccino.jpg'),
    create('coffee-iced', 'Vietnamese Latte', v2(115,135), 'assets/images/Easy_Organic_Vietnamese_Coffee_Recipe.jpg'),
    create('coffee-iced', 'Macadamia', v2(115,135), 'assets/images/macadamia.jpg'),
    create('coffee-iced', 'Butterscotch', v2(115,135), 'assets/images/Starbucks-Smoked-Butterscotch-Latte-Pin-5.jpg'),
    create('coffee-iced', 'Mocha', v2(115,135), 'assets/images/mocha.jpg'),
    create('coffee-iced', 'White Mocha', v2(115,135), 'assets/images/white vanilla.jpg'),
    create('coffee-iced', 'French Vanilla', v2(115,135), 'assets/images/french vanilla (2).jpg'),
    create('coffee-iced', 'Salted Caramel', v2(115,135), 'assets/images/salted caramel.jpg'),
    create('coffee-iced', 'Cereal Latte', v2(115,135), 'assets/images/coffee6.jpg'),

    
    create('frappuccino', 'Biscoff', v2(140,165, '16oz Medium', '22oz Large'), 'assets/images/Biscoff.jpg'),
    create('frappuccino', 'Java Chips', v2(150,165, '16oz Medium', '22oz Large'), 'assets/images/Java chips.jpg'),
    create('frappuccino', 'Caramel Macchiato', v2(150,165, '16oz Medium', '22oz Large'), 'assets/images/caramel macchiato.jpg'),
    create('frappuccino', 'Dark Mocha', v2(150,165, '16oz Medium', '22oz Large'), 'assets/images/Dark Mocha.jpg'),
    create('frappuccino', 'Milo Dinosaur', v2(140,165, '16oz Medium', '22oz Large'), 'assets/images/Milo Dinosaur.png'),
    create('frappuccino', 'Matcha', v2(140,165, '16oz Medium', '22oz Large'), 'assets/images/Matcha.jpg'),
    create('frappuccino', 'Oreo', v2(140,165, '16oz Medium', '22oz Large'), 'assets/images/Oreo.jpg'),
    create('frappuccino', 'Strawberry', v2(140,165, '16oz Medium', '22oz Large'), 'assets/images/Strawberry.jpg'),
    create('frappuccino', "Pulo't Frappe", v2(150,165, '16oz Medium', '22oz Large'), 'assets/images/Pulot.jpg'),
    create('frappuccino', 'Homemade Chocolate', v2(155,165, '16oz Medium', '22oz Large'), 'assets/images/Homemade Chocolate.jpg'),
    create('frappuccino', 'Blueberry Frappe', v2(140,165, '16oz Medium', '22oz Large'), 'assets/images/Blueberry.jpg'),

    
    create('hot-drinks', 'Matcha', v2(140,160), 'assets/images/matcha hot.jpg'),
    create('hot-drinks', "Pulo't", v2(150,170), 'assets/images/pulot hot.jpg'),
    ...
    create('hot-drinks', 'Espanner Latte', v2(140,160), 'assets/images/enspanner.jpg'),

    
    create('oat-milk', 'Oat Latte', v2(140,160), 'assets/images/oat.jpg'),
    create('oat-milk', 'Spanish Oat Latte', v2(140,160), 'assets/images/spanish.jpg'),
    create('oat-milk', 'White Mocha Oat', v2(140,160), 'assets/images/white.jpg'),
    create('oat-milk', 'Caramel Oat', v2(140,160), 'assets/images/caramel.jpg'),

    
    create('coffee-special', "Pulo't Coffee", v2(140,160), 'assets/images/pulot hot.jpg'),
    create('coffee-special', 'Tiramisu', v2(145,170), 'assets/images/tiramisu.jpg'),
    create('coffee-special', 'Barista Drink', v2(145,170), 'assets/images/barista.jpg'),
    create('coffee-special', 'Caramel Macchiato', v2(115,135), 'assets/images/caramel hot.jpg'),
    create('coffee-special', 'Sea Salt Latte', v2(115,135), 'assets/images/seasalt.jpg'),
    create('coffee-special', 'Biscoff', v2(115,150), 'assets/images/biscoff.jpg'),
    create('coffee-special', 'Espanner Latte', v2(115,140), 'assets/images/Einspanner.jpg'),

    
    create('non-coffee', 'Cocoa Dark Choco', v2(95,115), 'assets/images/cocoa.jpg'),
    create('non-coffee', 'Chocolate Float', v2(100,120), 'assets/images/float.jpg'),
    create('non-coffee', 'Strawberry Milk', v2(90,110), 'assets/images/strawberry float.jpg'),
    ...
    create('matcha-series', 'Matcha Latte', v2(110,125), 'assets/images/matchal.jpg'),
    create('matcha-series', 'Spanish Matcha', v2(110,140), 'assets/images/spanishmatcha.jpg'),
    create('matcha-series', 'Oat Milk Matcha', v2(130,150), 'assets/images/oatmatcha.png'),
    create('matcha-series', 'Ice Cream Matcha', v2(120,140), 'assets/images/icematcha.jpg'),
    create('matcha-series', 'White Choco Matcha', v2(110,130), 'assets/images/whitematcha.jpg'),
    create('matcha-series', 'Dirty Matcha', v2(130,150), 'assets/images/dirtymatcha.jpg'),
    ...
    create('juices', 'Lemonade', v2(70,90), 'assets/images/lemon.jpg'),
    create('juices', 'Mango Lemonade', v2(90,110), 'assets/images/mango.jpg'),
    create('juices', 'Mandarin', v2(70,105), 'assets/images/mandarin.jpeg'),
    create('juices', 'Frozen Peppermint', v2(140,160), 'assets/images/peppermint.jpg'),
    create('juices', 'Citrus Sunset', v2(90,110), 'assets/images/sunset.jpg'),
