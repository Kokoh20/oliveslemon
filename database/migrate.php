...
$productsData = [
    ...
    ['coffee-iced', 'Cappuccino', [['medium',90],['large',110]], 'assets/images/capuccino.jpg'],
    ['coffee-iced', 'Vietnamese Latte', [['medium',90],['large',110]], 'assets/images/Easy_Organic_Vietnamese_Coffee_Recipe.jpg'],
    ['coffee-iced', 'Hazelnut Latte', [['medium',90],['large',110]], 'assets/images/Homemade-Hazelnut-Iced-Coffee.jpg'],
    ['coffee-iced', 'Macadamia', [['medium',90],['large',110]], 'assets/images/macadamia.jpg'],
    ['coffee-iced', 'Butter Scotch', [['medium',90],['large',110]], 'assets/images/Starbucks-Smoked-Butterscotch-Latte-Pin-5.jpg'],
    ['coffee-iced', 'Mocha', [['medium',90],['large',110]], 'assets/images/mocha.jpg'],
    ['coffee-iced', 'White Mocha', [['medium',90],['large',110]], 'assets/images/white vanilla.jpg'],
    ['coffee-iced', 'French Vanilla', [['medium',90],['large',110]], 'assets/images/french vanilla (2).jpg'],
    ['coffee-iced', 'Salted Caramel', [['medium',90],['large',110]], 'assets/images/salted caramel.jpg'],

    // Frappuccino
    ['frappuccino', 'Biscoff', [['16oz Medium',140],['22oz Large',160]], 'assets/images/Biscoff.jpg'],
    ['frappuccino', 'Java Chips', [['16oz Medium',140],['22oz Large',160]], 'assets/images/Java chips.jpg'],
    ['frappuccino', 'Caramel Macchiato', [['16oz Medium',140],['22oz Large',160]], 'assets/images/caramel macchiato.jpg'],
    ['frappuccino', 'Dark Mocha', [['16oz Medium',140],['22oz Large',160]], 'assets/images/Dark Mocha.jpg'],
    ['frappuccino', 'Milo Dinosaur', [['16oz Medium',140],['22oz Large',160]], 'assets/images/Milo Dinosaur.png'],
    ['frappuccino', 'Matcha', [['16oz Medium',140],['22oz Large',160]], 'assets/images/Matcha.jpg'],
    ['frappuccino', 'Oreo', [['16oz Medium',140],['22oz Large',160]], 'assets/images/Oreo.jpg'],
    ['frappuccino', 'Strawberry', [['16oz Medium',140],['22oz Large',160]], 'assets/images/Strawberry.jpg'],
    ['frappuccino', "Pulo't Frappe", [['16oz Medium',140],['22oz Large',160]], 'assets/images/Pulot.jpg'],
    ['frappuccino', 'Homemade Chocolate', [['16oz Medium',155],['22oz Large',175]], 'assets/images/Homemade Chocolate.jpg'],
    ['frappuccino', 'Blueberry Frappe', [['16oz Medium',140],['22oz Large',160]], 'assets/images/Blueberry.jpg'],

    // Hot Drinks
    ['hot-drinks', 'Matcha', [['medium',140],['large',160]], 'assets/images/matcha hot.jpg'],
    ['hot-drinks', "Pulo't", [['medium',140],['large',160]], 'assets/images/pulot hot.jpg'],
    ...
    ['hot-drinks', 'Espanner Latte', [['medium',149],['large',160]], 'assets/images/enspanner.jpg'],

    // Oat Milk Based
    ['oat-milk', 'Oat Latte', [['medium',125],['large',145]], 'assets/images/oat.jpg'],
    ['oat-milk', 'Spanish Oat Lattee', [['medium',125],['large',145]], 'assets/images/spanish.jpg'],
    ['oat-milk', 'White Mocha Oat', [['medium',125],['large',145]], 'assets/images/white.jpg'],
    ['oat-milk', 'Caramel Oat', [['medium',125],['large',145]], 'assets/images/caramel.jpg'],

    // Coffee Special
    ['coffee-special', "Pulo't Coffee", [['medium',140],['large',160]], 'assets/images/pulot hot.jpg'],
    ['coffee-special', 'Tiramisu', [['medium',130],['large',150]], 'assets/images/tiramisu.jpg'],
    ['coffee-special', 'Barista Drink', [['medium',120],['large',140]], 'assets/images/barista.jpg'],
    ['coffee-special', 'Caramel Macchiato', [['medium',90],['large',110]], 'assets/images/caramel hot.jpg'],
    ['coffee-special', 'Sea Salt Latte', [['medium',90],['large',110]], 'assets/images/seasalt.jpg'],
    ['coffee-special', 'Biscoff', [['medium',100],['large',120]], 'assets/images/biscoff.jpg'],
    ['coffee-special', 'Espanner Latte', [['medium',90],['large',110]], 'assets/images/Einspanner.jpg'],

    // Non Coffee
    ['non-coffee', 'Cocoa Dark Chocolate', [['medium',90],['large',110]], 'assets/images/cocoa.jpg'],
    ['non-coffee', 'Chocolate Float', [['medium',90],['large',110]], 'assets/images/float.jpg'],
    ['non-coffee', 'Strawberry Float', [['medium',90],['large',110]], 'assets/images/strawberry float.jpg'],
    ...
    // Matcha Series
    ['matcha-series', 'Matcha Latte', [['medium',90],['large',110]], 'assets/images/matchal.jpg'],
    ['matcha-series', 'Spanish Matcha', [['medium',100],['large',129]], 'assets/images/spanishmatcha.jpg'],
    ['matcha-series', 'Oat Milk Matcha', [['medium',125],['large',145]], 'assets/images/oatmatcha.png'],
    ['matcha-series', 'Ice Cream Matcha', [['medium',120],['large',120]], 'assets/images/icematcha.jpg'],
    ['matcha-series', 'White Choco Matcha', [['medium',110],['large',130]], 'assets/images/whitematcha.jpg'],
    ['matcha-series', 'Matcha Espanner', [['medium',100],['large',120]], 'assets/images/MatchaEinspanner.jpg'],
    ['matcha-series', 'Dirty Matcha', [['medium',120],['large',140]], 'assets/images/dirtymatcha.jpg'],
    ['matcha-series', 'Strawberry Matcha', [['medium',120],['large',140]], 'assets/images/strawberrymatcha.jpg'],
    ['matcha-series', 'Chocoberry Matcha', [['medium',120],['large',140]], 'assets/images/chocmatcha.jpg'],

    // Juices
    ['juices', 'Aloe Vera', [['medium',70],['large',90]], 'assets/images/aloe.jpg'],
    ['juices', 'Lemonade', [['medium',65],['large',85]], 'assets/images/lemon.jpg'],
    ['juices', 'Mango Lemonade', [['medium',85],['large',105]], 'assets/images/mango.jpg'],
    ['juices', 'Mandarin', [['medium',70],['large',90]], 'assets/images/mandarin.jpeg'],
    ['juices', 'Frozen Lemonade Peppermint', [['medium',140],['large',160]], 'assets/images/peppermint.jpg'],
    ['juices', 'Citrus Sunset', [['medium',85],['large',105]], 'assets/images/sunset.jpg'],
